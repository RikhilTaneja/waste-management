...
export default function Donation() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/pay/getkey")
      .then((res) => {
        console.log(res);
        setKey(res.data.key)
      })
